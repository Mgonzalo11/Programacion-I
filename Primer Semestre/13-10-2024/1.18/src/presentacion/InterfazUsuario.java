...
public class InterfazUsuario {
    // Método que ejecuta la instrucción del usuario, procesando el comando proporcionado.
    ...
    public static void ejecutar(String instruccion) {
        ...
        if (instruccion.equalsIgnoreCase("mostrar")) {
            mostrarOficinaPadron(padron); // Si la instrucción es correcta, llama al método para mostrar el padrón de habitantes.
        } else if (instruccion.equalsIgnoreCase("añadir")) {
            // Si la instrucción es "añadir", ejecuta el método para añadir un nuevo habitante.
    ...
    // Método privado que muestra los habitantes en el padrón.
    private static void mostrarOficinaPadron(OficinaPadron padron) {
        // Obtiene la lista de habitantes del padrón utilizando el método 'getHabitantesPadron'.
        ...
        // Muestra el número total de habitantes en el padrón utilizando el método 'calcularNumeroHabitantes'.
        System.out.println("El número total de habitantes es " + padron.calcularNumeroHabitantes());
    }

    // Método privado para añadir un nuevo habitante al padrón.
    private static void añadirHabitante(OficinaPadron padron) {
        ...
        // Añade el nuevo habitante al padrón usando el método 'añadir' de la clase OficinaPadron.
